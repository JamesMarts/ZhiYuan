...
public class PowerfulEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public PowerfulEditText(Context context, AttributeSet attrs, int defStyle) {
        ...
        eyeCloseResourseId = ta.getResourceId(R.styleable.PowerfulEditText_eyeClose, R.drawable.ic_powerful_edit_text_eye_close);
        eyeOpenResourseId = ta.getResourceId(R.styleable.PowerfulEditText_eyeOpen, R.drawable.ic_powerful_edit_text_eye_open);
